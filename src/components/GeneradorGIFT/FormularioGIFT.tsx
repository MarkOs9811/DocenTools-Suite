    ...
    <div className="modern-card p-4 h-100 d-flex flex-column">
      ...
      >
        ...
        <div className="mb-1">
          ...
          <select {...register("type")} className="input-modern ">
        ...
        <div className="mb-4">
          ...
          <p className="text-muted small mb-1">
            Presiona Enter para agregar más opciones.
          </p>

          {fields.map((field, index) => (
            <div
              key={field.id}
              className="mb-1 p-2 bg-light rounded-3 position-relative"
            >
              <input
              ...
              <input
                ...
                className="input-modern border-light bg-white p-2 text-dark fw-bold"
              ...
              {questionType === "multiple_choice" && fields.length > 1 && (
                <button
                  ...
                  className="btn btn-sm text-danger position-absolute end-0 top-0 my-3 mx-4"
                >
